...
namespace CarpoolApp.Services.Test.EFHelpers
{
    ...
    public static class EFHelperClass
    {
        public static DbSet<T> GetMockDbSet<T>(IQueryable<T> data) where T : class
        {
            var dbSet = Substitute.For<DbSet<T>, IQueryable<T>, IDbAsyncEnumerable<T>>();
            ...
            ((IQueryable<T>)dbSet).AsNoTracking().Returns(dbSet);
